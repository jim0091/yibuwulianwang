...
#define ADDRESS "tcp://yibuwulianwang.com:1883"//这里替换成OneNET的服务器IP和端口号，或者百度物接入IoT的
#define CLIENTID "DuerOS" //clientID在OneNET上是 设备ID
...
{
  int rc;
  printfAndWriteMyLogFun("Connection OneNet lost! Cause:%s\n", cause);
  //2018-04-07 23:05:05 Connection OneNet lost! Cause:(null)
  //2018-04-07 23:05:05 MQTTClient_isConnected:(null)
  //MQTTClient client = (MQTTClient)context;
  printfAndWriteMyLogFun("MQTTClient_isConnected:%s\n",(char*)MQTTClient_isConnected(client));
